...
if(isset($_POST['sub'])){
    $otp=$_POST['otp'];
    $q1="select otp , time from doc_otp where mail ='".$mail."'";
    ...
    while ($row=mysqli_fetch_array($result)){
        ...
        if($otp==$row[0]){
            ...
            if((int)$y[1]<5 and (int)$y[0]==0){
                header("Location:../project/logindoc.php?mail=".$mail);
            }
            else{
                echo 'nope';
            }
...
<div class="container be-detail-container">
    <div class="row">
        <div class="col-sm-6 col-sm-offset-3">
            ...
            <form method="post" id="veryfyotp" action="dotp_check.php?mail=<?php echo $_GET['mail'];?>">
                <div class="row">
