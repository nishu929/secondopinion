    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2 text-xs-center">
                ...
                include ("connect.php");
                $id=$_GET['id'];
                $q1 = "select * from patient_message where id='".$id."'";
                $q2 = "UPDATE `patient_message` SET `m_read`='yes' WHERE id ='".$id."'";
                $result = mysqli_query($conn,$q1);
                $result2 = mysqli_query($conn,$q2);
                while ($row = mysqli_fetch_array($result)){
//print_r($result);
                    ?>
                    <h6 class="mbr-section-title display-2"><?php echo $row['subject']?></h6>
